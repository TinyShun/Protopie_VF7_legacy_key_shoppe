...
//·············································································
  ...
  public : CANFDMessage (uint32_t inId, bool inExt, Type inType, u_int8_t inIdx, uint8_t inLen, const uint8_t (&inData)[64]) :
  id (inId),  // Frame identifier
  ext (inExt), // false -> base frame, true -> extended frame
  type (inType),
  idx (inIdx),  // This field is used by the driver
  len (inLen), // Length of data (0 ... 64)
  data() {
